    ...
    <div className="w-full max-w-4xl mx-auto p-4">
      <Card className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="text-center mb-6">
          <h2 className="text-3xl font-bold text-blue-700 mb-2">Sopa de Letras</h2>
          <p className="text-gray-600">
            Encuentra {words.length} palabras relacionadas al sistema nervioso
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-4">
              <p className="text-sm font-semibold text-gray-700 mb-2">Palabras encontradas:</p>
            ...
            <div className="mb-4">
              <p className="text-sm font-semibold text-gray-700 mb-2">Puntuación:</p>
